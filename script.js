...
let profile={name:'Faris',bio:'A student exploring AI, technology, and whatever interesting thing comes next.',email:'farisdomain@gmail.com',instagram:'https://www.instagram.com/farixhere/',github:'https://github.com/dupekingsam-code',hero_image:''};
...
$('#closeAsk').addEventListener('click',closeAsk);$('#askModal').addEventListener('click',e=>{if(e.target===e.currentTarget)closeAsk()});
